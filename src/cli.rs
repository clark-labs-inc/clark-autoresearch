...
enum Command {
    ...
    /// and returns a candidate JSON on stdout. the crate owns the loop body
...
// proposer command live in the host; the crate owns only the loop body.
// ---------------------------------------------------------------------------
...
/// host while the crate owns the proposal orchestration.
